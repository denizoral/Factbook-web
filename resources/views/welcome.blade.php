...
@section('content')
    ...
    <div>
        ...
        <h4 class="text-center">Factbook is a website where you can talk about facts of places you visit, things you buy, or for just general conversations.</h4>
        <h4 class="text-center">Sit back and enjoy the conversations online!</h4>
        <hr>
        <h2 class="display-4 text-center">How do I start?</h2>
        @if (Auth::user())
        <h4 class="text-center">Seems like you're already logged in! Click the factbook logo on top left and enjoy the content! :)</h4>
        @else
